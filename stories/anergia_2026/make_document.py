...
w(f"\n**Κατάσταση:** specification_complete · preview_complete · visual approval: {P['visual_review']['approval_status']} · render_status: {P['execution']['render_status']} · παραδοτέο εξαγωγής: DATA_STORY_ANERGIA.stage.html (Claude2Video Stage Export Format), MP4 μέσω claude2video.com· τοπικό MP4 ως ανεξάρτητη επαλήθευση.\n")
