/* DATA STORY Stage runtime: React 18.3 + ReactDOM + Stage/useTime (Claude2Video Stage Export Format) + timeline component. Generated from web/src/stage-runtime/*.jsx with esbuild; locked by SHA256 in the skill. */
(() => {
  ...
  // src/stage-runtime/entry.jsx
  var import_react2 = __toESM(require_react());
  var import_client = __toESM(require_client());

  // src/stage-runtime/animations.jsx
  var import_react = __toESM(require_react());
  var import_jsx_runtime = __toESM(require_jsx_runtime());
  var TimeCtx = (0, import_react.createContext)(0);
  function useTime() {
    return (0, import_react.useContext)(TimeCtx);
  }
  function Stage({ width, height, duration, fps = 25, autoPlay = true, loop = true, children }) {
    const [time, setTime] = (0, import_react.useState)(0);
    const [playing, setPlaying] = (0, import_react.useState)(autoPlay && !/[?&]__render=1/.test(location.search));
    ...
    (0, import_react.useEffect)(() => {
      ...
      window.__seek = (s) => {
        setPlaying(false);
        setTime(Math.min(Math.max(s, 0), duration));
      };
      window.__play = () => setPlaying(true);
    }, [width, height, duration, fps]);
    (0, import_react.useEffect)(() => {
      if (!playing) return;
      const t0 = performance.now() - timeRef.current * 1e3;
      let raf;
      const step = () => {
        const s = (performance.now() - t0) / 1e3;
        setTime(loop ? s % duration : Math.min(s, duration));
        raf = requestAnimationFrame(step);
      };
      raf = requestAnimationFrame(step);
      return () => cancelAnimationFrame(raf);
    }, [playing, duration, loop]);
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TimeCtx.Provider, { value: time, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width, height, transform: "scale(1)", transformOrigin: "0 0", position: "relative", overflow: "hidden" }, children }) });
  }
  ...
  var PRODUCTION = window.DATA_STORY_PRODUCTION;
  var WIDTH = PRODUCTION.canvas.width;
  var HEIGHT = PRODUCTION.canvas.height;
  var FPS = PRODUCTION.canvas.fps;
  var DURATION = PRODUCTION.total_duration_ms / 1e3;
  function DataStoryTimeline() {
    const t = useTime();
    const host = (0, import_react2.useRef)(null), player = (0, import_react2.useRef)(null);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { ref: host, style: { width: WIDTH, height: HEIGHT, position: "relative", overflow: "hidden", background: "#121B37" } });
  }
  ...
  window.addEventListener("unhandledrejection", (e) => {
    window.__pageError = String(e.reason && (e.reason.message || e.reason));
  });
  (0, import_client.createRoot)(document.getElementById("root")).render(
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Stage, { width: WIDTH, height: HEIGHT, duration: DURATION, fps: FPS, autoPlay: true, loop: false, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DataStoryTimeline, {}) })
  );
})();
