...
| P14 | Πλήρες MP4 του demo reel από το ίδιο HTML (διορθωμένο crossfade) | PASS | 1200 καρέ, 48,00 s, 1080×1920, 25 fps, H.264 yuv420p, 2,1 MB, full decode OK, 91 min wall (SwiftShader). Σε κάθε όριο σκηνής το μέσο καρέ του crossfade 400 ms δείχνει και τις δύο σκηνές σε μερική αδιαφάνεια, κανένα καρέ χωρίς περιεχόμενο |
